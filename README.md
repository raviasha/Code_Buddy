...
Download the latest pilot release from the [Code Buddy releases page](https://github.com/raviasha/Code_Buddy/releases/tag/v0.6.2):

- `code-buddy-0.6.2.vsix` — VS Code extension installer.
...
2. Select `code-buddy-0.6.2.vsix`.
